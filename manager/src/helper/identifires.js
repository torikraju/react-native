...
export const local_store = {
    ...
    expiryDate: 'manager:auth:expiryDate',
    refreshToken: 'manager:auth:refreshToken',
    userId: 'manager:auth:userId'
};

export const api_key = 'AIzaSyD08s8WPuRCdmR58SG1b86mIW4J6haLZvE';
